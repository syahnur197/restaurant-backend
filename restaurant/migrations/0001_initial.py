# Generated by Django 3.2.11 on 2022-01-29 18:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('restaurant-admin', 'Restaurant Admin'), ('restaurant-manager', 'Restaurant Manager'), ('restaurant-finance', 'Restaurant Finance'), ('branch-manager', 'Branch Manager'), ('branch-staff', 'Branch Staff')], default='restaurant-admin', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_gateway', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='restaurant.paymentgateway')),
                ('restaurant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='restaurant.restaurant')),
            ],
            options={
                'get_latest_by': 'modified',
